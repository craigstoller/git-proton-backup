...
**Status:** design, 2026-08-03. Brainstormed with Craig; scope, cache home, and gate mechanism decided in conversation. Revised once under peer review (see Revisions).
