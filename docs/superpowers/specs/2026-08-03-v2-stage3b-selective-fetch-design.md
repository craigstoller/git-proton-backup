...
**Post-implementation reconciliation (2026-08-04, from the final whole-branch review).** Three deliberate narrowings the shipped, gated code makes against this document's letter, recorded here so the next implementer inherits fact rather than intent:
